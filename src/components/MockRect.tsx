...
export class CollidingRectangles extends React.Component{
    ...
    static readonly r1 = <MockRect id={"R1"} height={10} width={200} left={-50} top={-50}/>
    static readonly r2 = <MockRect id={"R2"} height={10} width={200} left={-50} top={130}/>
    static readonly r3 = <MockRect id={"R3"} height={180} width={10} left={-30} top={-70}/>
    static readonly r4 = <MockRect id={"R4"} height={180} width={10} left={130} top={-20}/>
    static readonly r5 = <MockRect id={"R5"} height={50} width={50} left={25} top={25}/>
    static readonly r6 = <MockRect id={"R6"} height={20} width={20} left={90} top={-10}/>
    static readonly r7 = <MockRect id={"R7"} height={20} width={20} left={90} top={50}/>
    static readonly r8 = <MockRect id={"R8"} height={20} width={20} left={90} top={90}/>
    static readonly r0 =
        <div id="R0" title="R0" style={{position: "absolute",height:100,width:100,left:75,top:250,border:"thin solid red"}}>
            R0
            {CollidingRectangles.r1}
            {CollidingRectangles.r2}
            {CollidingRectangles.r3}
            {CollidingRectangles.r4}
            {CollidingRectangles.r5}
            {CollidingRectangles.r6}
            {CollidingRectangles.r7}
            {CollidingRectangles.r8}
        </div>
    render(){
        let result =
            <div>
